...
<style>
    ...
    .notifications-item .text label {
        color: #aaa;
        font-size: 12px
    }

    .notifications-item .text span {
        color: black;
        font-size: 12px
    }
</style>
<!--akhir css untuk notifikasi-->
<nav class="sb-nav-fixed sb-topnav navbar navbar-expand navbar-dark bgfooter">
    <!-- Navbar Brand-->
    <a <?php if (session('nama_role') == $role::ROLE_ADMIN) { ?> href="<?= base_url() . '/admin/beranda'; ?>" <?php } else { ?> href="<?= base_url() . '/karyawan/beranda'; ?>" <?php } ?>><img src="<?= base_url() . '/assets/img/logo.png'; ?>" alt="" width="200" height="55" class=""></a>
    ...
    <!-- start, views tabel notifikasi di sistem beserta tanggal dan data -->
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        ...
        <div class="notifications" id="box">
            ...
            <!--end, tampilan tabel untuk notifikasi -->
        ...
        <li class="nav-item dropdown">
            <!--role admin dan user, dropdown item profil saya dan logout -->
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <?php } else { ?>
                    <li><a class="dropdown-item" href="<?= base_url('/karyawan/profile'); ?>">Profil Saya</a></li>
                <?php } ?>
...
<script>
    // fungsi seperti toggle di js, ketika notifikasi muncul lalu diklik dan notifikasi di klik lagi maka tidak muncul
    var down = false;
